...
const calcHowFar = (clientPosition, prevClientPosition) => {
  return clientPosition - prevClientPosition;
};

const calcVelocity = (scroll, prevScroll) => {
  return scroll - prevScroll;
};

const ifIsForward = (value) => Math.sign(value) === -1;

export const useNativeSlider = ({
